<template><div><h2 id="命令" tabindex="-1"><a class="header-anchor" href="#命令" aria-hidden="true">#</a> 命令</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="端口开放" tabindex="-1"><a class="header-anchor" href="#端口开放" aria-hidden="true">#</a> 端口开放</h2>
<figure><img src="@source/zh/guide/install/assets/assets/20230731182645.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>云服务器入方向开通80端口</p>
<h2 id="打开验证" tabindex="-1"><a class="header-anchor" href="#打开验证" aria-hidden="true">#</a> 打开验证</h2>
...
<figure><img src="@source/zh/guide/install/assets/assets/20230731182737.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="配置gitlab域名-否则项目git-clone的地址时错" tabindex="-1"><a class="header-anchor" href="#配置gitlab域名-否则项目git-clone的地址时错" aria-hidden="true">#</a> 配置GitLab域名，否则项目git clone的地址时错</h2>
